...
import { lang_md } from "./highlightMD";
import { lang_js } from "./highlightJS";
import { lang_xml } from "./highlightXML";
...
export default function (hljs = {}) {
  ...
  function expand_or_clone_mode(mode) {
    ...
    if (dependencyOnParent(mode))
      return [
        inherit(mode, { starts: mode.starts ? inherit(mode.starts) : null }),
      ];
  ...
  hljs.registerLanguage("markdown", lang_md);
  hljs.registerLanguage("javascript", lang_js);
